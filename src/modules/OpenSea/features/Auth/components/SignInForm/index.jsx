          ...
          return (
            <Form>
              ...
              <div className="pb-5 pb-lg-15">
                <h3 className="font-weight-bolder text-white font-size-h2 font-size-h1-lg">
                  {t('OpenSea')}
                </h3>
                <div className="text-white-50 font-weight-bold font-size-h5">
                  {`${t('AdminPage')}`}
              ...
              <Field
                ...
                appendLabelElement={
                  <a
                    href="#"
                    className="text-white font-size-lg font-weight-bolder mb-2"
                    style={{
