  ...
  return (
    ...
    >
      ...
      <div className="login login-3 wizard d-flex flex-column flex-lg-row flex-column-fluid bg-transparent">
        {/* begin::Aside */}
        <div
          className="login-aside d-flex flex-column flex-row-auto SignIn_Aside position-relative bg-transparent"
          style={{
            boxShadow: 'none',
          }}
        >
          ...
          <div className="w-100 h-100 SignIn_AsideBG d-flex align-items-center justify-content-center justify-content-lg-end bg-transparent overflow-hidden">
            <div
              className="p-10 d-flex flex-column align-items-center"
              style={{
                width: '80%',
              }}
            >
              ...
              />
              <div
                className="font-size-h2 font-weight-boldest text-center text-white"
                style={{
                  width: '80%',
                }}
              >
        ...
        <div className="login-content flex-row-fluid d-flex flex-column p-10 bg-transparent">
          ...
          <div className="text-right d-flex justify-content-center align-items-center">
            <div className="top-signin text-right d-flex justify-content-end pb-lg-0">
              <span className="font-weight-bold text-white font-size-h5">{`${t(
                'ChangeLanguage'
              )}`}</span>
            ...
            <div className="">
              {/* Languages */}
              <Dropdown isOpen={languageMenuVisible} toggle={toggleLanguageMenu} className="ml-2">
                <DropdownToggle caret={false} className="border-0 p-0 bg-transparent">
                  <div
                    className="topbar-item"
                    data-toggle="dropdown"
                    data-offset="10px,0px"
                    aria-expanded={`${languageMenuVisible ? 'true' : 'false'}`}
                  >
                    <a
                      href="#"
                      className="btn btn-icon btn-bg-white btn-hover-primary btn-icon-primary btn-circle btn-dropdown"
                      onClick={toggleLanguageMenu}
                    >
                      <img
                        className="h-20px w-20px rounded-circle"
                        src={currentAppLanguageItem.icon}
                        alt=""
                      />
                    </a>
                  </div>
          ...
          <div className="d-flex flex-row-fluid flex-center justify-content-center justify-content-lg-start">
            ...
            <div className="login-form">
              {/* begin: Form */}
              <SignInForm onSubmit={handleSubmit} onSignInGoogle={handleSignInGoogle} />
              {/* end: Form */}
            </div>
            {/* end::Sign In */}
          </div>
